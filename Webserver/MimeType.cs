...
namespace Webserver
{
	...
	{
		// Token: 0x0600CE70 RID: 52848 RVA: 0x004B2B3C File Offset: 0x004B0D3C
		public static string GetMimeType(string _extension)
		{
			...
			string result;
			if (!MimeType.mappings.TryGetValue(_extension, out result))
			{
		...
		public static readonly IDictionary<string, string> mappings = new CaseInsensitiveStringDictionary<string>
		{
			{
				".323",
				"text/h323"
